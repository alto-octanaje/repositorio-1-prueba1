...
function crearClaseMascota() {
  class Mascota {
    constructor(nombre, dueño, actividades) {
      ...
      // ej:[{actividad: 'salir a caminar', frecuencia: '1 vez al dia'}, {actividad: 'baño', frecuencia: '1 vez al mes'}]
    ...
    addActividad(actividad, frecuencia) {
      ...
      // Tu código aca:
        ...
        Mascota.actividad.push(frecuencia);
      }
